...
void
BlockFloatCompander::BFPCompressUserPlaneAvxSnc(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  case 9:
    BFP_UPlane_SNC::compressByAllocN<BlockFloatCompander::networkBytePack9bSnc>(dataIn, dataOut, totShiftBits9, totNumBytesPerRB9, rbWriteMask9);
    break;

  case 10:
    BFP_UPlane_SNC::compressByAllocN<BlockFloatCompander::networkBytePack10bSnc>(dataIn, dataOut, totShiftBits10, totNumBytesPerRB10, rbWriteMask10);
    break;
...
/// Starts by determining iqWidth specific parameters and functions.
void
BlockFloatCompander::BFPExpandUserPlaneAvxSnc(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  case 9:
    BFP_UPlane_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack9bSnc>(dataIn, dataOut, k_totNumBytesPerRB9, k_maxExpShift9);
    break;

  case 10:
    BFP_UPlane_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack10bSnc>(dataIn, dataOut, k_totNumBytesPerRB10, k_maxExpShift10);
    break;
