...
void
BlockFloatCompander::BFPCompressCtrlPlane32AvxSnc(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  case 9:
    BFP_CPlane_32_SNC::compressByAllocN<BlockFloatCompander::networkBytePack9bSnc>(dataIn, dataOut, totShiftBits9, totNumBytesPerBlock, totNumBytesPerReg, rbWriteMask9);
    break;

  case 10:
    BFP_CPlane_32_SNC::compressByAllocN<BlockFloatCompander::networkBytePack10bSnc>(dataIn, dataOut, totShiftBits10, totNumBytesPerBlock, totNumBytesPerReg, rbWriteMask10);
    break;

  case 12:
    BFP_CPlane_32_SNC::compressByAllocN<BlockFloatCompander::networkBytePack12bSnc>(dataIn, dataOut, totShiftBits12, totNumBytesPerBlock, totNumBytesPerReg, rbWriteMask12);
    break;

  case 14:
    BFP_CPlane_32_SNC::compressByAllocN<BlockFloatCompander::networkBytePack14bSnc>(dataIn, dataOut, totShiftBits14, totNumBytesPerBlock, totNumBytesPerReg, rbWriteMask14);
    break;
  }
}
...
/// Starts by determining iqWidth specific parameters and functions.
void
BlockFloatCompander::BFPExpandCtrlPlane32AvxSnc(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  case 9:
    BFP_CPlane_32_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack9bSnc>(dataIn, dataOut, totNumBytesPerBlock, totNumBytesPerReg, k_maxExpShift9);
    break;

  case 10:
    BFP_CPlane_32_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack10bSnc>(dataIn, dataOut, totNumBytesPerBlock, totNumBytesPerReg, k_maxExpShift10);
    break;

  case 12:
    BFP_CPlane_32_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack12bSnc>(dataIn, dataOut, totNumBytesPerBlock, totNumBytesPerReg, k_maxExpShift12);
    break;

  case 14:
    BFP_CPlane_32_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack14bSnc>(dataIn, dataOut, totNumBytesPerBlock, totNumBytesPerReg, k_maxExpShift14);
    break;
  }
}
