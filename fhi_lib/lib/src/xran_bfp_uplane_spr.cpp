...
#pragma unroll(4)
  ...
  applyCompressionN_1RB(const BlockFloatCompander::ExpandedData& dataIn, BlockFloatCompander::CompressedData* dataOut,
                        const int numREOffset, const uint8_t thisExp, const int thisRBExpAddr, const uint64_t rbWriteMask)
  {
  ...
  compressN_16RB(const BlockFloatCompander::ExpandedData& dataIn, BlockFloatCompander::CompressedData* dataOut,
                 const __m512i totShiftBits, const int totNumBytesPerRB, const uint64_t rbWriteMask)
  {
...
#pragma unroll(4)
  ...
  applyExpansionN_1RB(const BlockFloatCompander::CompressedData& dataIn, BlockFloatCompander::ExpandedData* dataOut,
                      const int expAddr, const int thisRBAddr, const int maxExpShift, float fScale)
  {
  ...
  expandByAllocN(const BlockFloatCompander::CompressedData& dataIn, BlockFloatCompander::ExpandedData* dataOut,
                 const int totNumBytesPerRB, const int maxExpShift, float fScale)
  {
    switch (dataIn.numBlocks)
    {
    case 16:
...
#pragma unroll(4)
  ...
  applyExpansion8_1RB(const BlockFloatCompander::CompressedData& dataIn, BlockFloatCompander::ExpandedData* dataOut,
                      const int expAddr, const int thisRBAddr, float fScale)
  {
    __m512h ph_xmmX, fpscale = _mm512_set1_ph((_Float16)1 /fScale);
  ...
  void
  expandByAlloc8(const BlockFloatCompander::CompressedData& dataIn, BlockFloatCompander::ExpandedData* dataOut, float fScale)
  {
    switch (dataIn.numBlocks)
    {
    case 16:
...
void
BlockFloatCompander::BFPExpandUserPlaneSpr(const CompressedData& dataIn, ExpandedData* dataOut, float fScale)
{
  ...
  case 9:
    BFP_UPlane_SPR::expandByAllocN<BlockFloatCompander::networkByteUnpack9bSnc>(dataIn, dataOut, k_totNumBytesPerRB9, k_maxExpShift9, fScale);
    break;

  case 10:
    BFP_UPlane_SPR::expandByAllocN<BlockFloatCompander::networkByteUnpack10bSnc>(dataIn, dataOut, k_totNumBytesPerRB10, k_maxExpShift10, fScale);
    break;

  case 12:
    BFP_UPlane_SPR::expandByAllocN<BlockFloatCompander::networkByteUnpack12bSnc>(dataIn, dataOut, k_totNumBytesPerRB12, k_maxExpShift12, fScale);
    break;
  }
}
